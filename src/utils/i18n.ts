...
export const zh = {
  ...
  privacy: '本站所有二维码和条形码生成、识别和批量处理均在您的浏览器本地完成，不保存您提交的数据，不涉及您的隐私。',
  generator: {
  ...
  barcode: {
    ...
    downloadPng: '下载 PNG',
    downloadSvg: '下载 SVG',
    invalid: '当前条码类型无法编码该内容，请检查长度或字符规则。',
  },
  home: {
    whyEyebrow: 'Why MYQR',
    whyTitle: '为什么选择 MYQR',
    ...
    faqs: [
      ...
      ['生成的二维码有有效期吗？', '没有。二维码本身是静态图像，不包含任何时效信息，一旦生成即可长期使用。'],
      ['批量生成时 TXT 文件每行只能放一个二维码内容吗？', '是的。TXT 文件中每行对应一个二维码，系统会逐行读取并生成对应 PNG 图片。'],
      ['二维码容错率是什么意思？', '容错率表示二维码被遮挡或损坏后仍可被识别的能力。叠加 Logo 或用于印刷时建议选择 H。'],
      ['生成的二维码可以商用吗？', '可以。本站生成的是静态二维码图片，不附加版权限制，可用于个人项目或商业用途。'],
      ['网站支持活码吗？', '不支持。活码需要服务器中转和数据库存储，本站主打纯前端本地处理，因此仅生成静态二维码。'],
      ['我想了解一物一码技术，该怎么实施？', '一物一码技术广泛应用于防伪、追溯、防窜货、营销等场景，涉及编码规则设计、数据库管理、扫码验证等多个环节。如需了解或实施方案，欢迎联系咨询：QQ 2280476667。'],
    ],
  },
};
...
export const en = {
  ...
  privacy: 'All QR and barcode generation, decoding, and batch processing run locally in your browser. We do not save submitted data or touch your privacy.',
  generator: {
    eyebrow: 'QR Code Generator',
  ...
  barcode: {
    ...
    aside: 'Runs locally, supports PNG / SVG download',
    ...
    background: 'Background',
    result: 'Result',
    empty: 'Enter content to generate a barcode',
    downloadPng: 'Download PNG',
    downloadSvg: 'Download SVG',
    invalid: 'This barcode type cannot encode the current content. Check length or character rules.',
  },
  home: {
    whyEyebrow: 'Why MYQR',
    ...
    faqs: [
      ...
      ['Do generated QR codes expire?', 'No. A QR code is a static image with no expiration data.'],
      ['Does one TXT line map to one QR code during batch generation?', 'Yes. Each line in the TXT file is read as one QR code content item.'],
      ...
      ['How can I implement item-level unique QR codes?', 'Item-level QR solutions often involve encoding rules, database management, and scan verification. For consulting, contact QQ: 2280476667.'],
    ],
  },
};
